...
<form method="post" id="FSForm" action="Search">
    ...
    <div><label>Min Trip Start Date: </label><input cols="12" id="minTripStartDate" name="minTripStartDate" placeholder="Min trip start Date" rows="1"  type="date"></div>
    <br/>
    <div><label>Max Trip Start Date: </label><input cols="12" id="maxTripStartDate" name="maxTripStartDate" placeholder="Max trip start Date" rows="1"  type="date"></div>

    <br/>
    <div><input  data-val="true" id="lengthOfStay" name="lengthOfStay" placeholder="Length Of Stay" type="text"  value=""/></div>

    <div>
        <input id="minStarRating" name="minStarRating" placeholder="Min Star Rating" step="any" type="number"  value="">
        <label style="width:10%;padding:12px 24px; font-size:34px">-</label>
        <input id="maxStarRating" name="maxStarRating" placeholder="Max Star Rating" step="any" type="number"  value="">
    </div>

    <div>
        <input id="minTotalRate" name="minTotalRate" placeholder="Min Total Rate" type="number"  value="">
        <label style="width:10%;padding:12px 24px; font-size:34px">-</label>
        <input id="maxTotalRate" name="maxTotalRate" placeholder="Max Total Rate" type="number"  value="">
    </div>

    <div>
        <input id="minGuestRating" name="minGuestRating" placeholder="Min Guest Rate" type="number"  value="">
        <label style="width:10%;padding:12px 24px; font-size:34px">-</label>
        <input id="maxGuestRating" name="maxGuestRating" placeholder="Max Guest Rate" type="number"  value="">
    </div>
